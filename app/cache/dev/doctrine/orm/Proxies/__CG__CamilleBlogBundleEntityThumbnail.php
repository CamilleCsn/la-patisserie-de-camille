...
namespace Proxies\__CG__\Camille\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Thumbnail extends \Camille\BlogBundle\Entity\Thumbnail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Camille\\BlogBundle\\Entity\\Thumbnail' . "\0" . 'id', '' . "\0" . 'Camille\\BlogBundle\\Entity\\Thumbnail' . "\0" . 'url', '' . "\0" . 'Camille\\BlogBundle\\Entity\\Thumbnail' . "\0" . 'alt', '' . "\0" . 'Camille\\BlogBundle\\Entity\\Thumbnail' . "\0" . 'file', '' . "\0" . 'Camille\\BlogBundle\\Entity\\Thumbnail' . "\0" . 'tempFilename'];
        }
